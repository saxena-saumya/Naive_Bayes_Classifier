...
# File Name: bayes_template_best.py - to implement the improved classifier.
...
class Best_Bayes_Classifier:
   ...
   def __init__(self, trainDirectory = "movies_reviews/"):
      ...
      self.positiveFile_ = 'positive_best.pickle' ; self.negativeFile_ = 'negative_best.pickle' ; self.totalFile_ = 'total_best.pickle'
...
#               print(afile)
               if "txt" in afile:     
                  ...
                  if (reviewRank > 0):
                     ...
                     for token in range_ngrams(ftokens) :
   ...
   def classify(self, sText):
      ...
      for token in range_ngrams(inputTokens):
         # print ( token )
